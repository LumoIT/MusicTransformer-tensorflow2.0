...
parser.add_argument('--pickle_dir', default='music', help='dataset path')
parser.add_argument('--max_seq', default=2048, help='max length')
parser.add_argument('--epochs', default=100, help='epoch number')
parser.add_argument('--load_path', default="result/0722", help='model load path')
parser.add_argument('--save_path', default="result/0722", help='model storage path')
